...
void main() {
    ...
    if(canvasColorSpace < 0.5) {
        adjustedColor = vec3(color.r + 0.02125, color.g + 0.02125, color.b + 0.02125);
    }
    color.rgb = clamp(adjustedColor, 0.0, 1.0);
